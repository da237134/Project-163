...
q1.pack()
q1_r1 = Radiobutton(root, text = "Yes", variable = q1_rBtn, value = "Yes", bg = "white")
q1_r1.pack()
q1_r2 = Radiobutton(root, text = "No", variable = q1_rBtn, value = "No", bg = "green")
q1_r2.pack()
...
q2.pack()
q2_r1 = Radiobutton(root, text = "Yes", variable = q2_rBtn, value = "Yes", bg = "orange")
q2_r1.pack()
q2_r2 = Radiobutton(root, text = "No", variable = q2_rBtn, value = "No", bg = "white")
q2_r2.pack()
...
q3.pack()
q3_r1 = Radiobutton(root, text = "Yes", variable = q3_rBtn, value = "Yes", bg = "white")
q3_r1.pack()
q3_r2 = Radiobutton(root, text = "No", variable = q3_rBtn, value = "No", bg = "green")
q3_r2.pack()
...
q4.pack()
q4_r1 = Radiobutton(root, text = "Yes", variable = q4_rBtn, value = "Yes", bg = "orange")
q4_r1.pack()
q4_r2 = Radiobutton(root, text = "No", variable = q4_rBtn, value = "No", bg = "white")
q4_r2.pack()
